...
setTrend(days)
  ...
  return (
    <Layout>
      <h1 className="text-2xl font-bold text-text mb-6">This Month</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl p-6 text-white">
          ...
          <p className="text-2xl font-bold mt-2">₹{data.totalIncome.toFixed(2)}</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-700 rounded-2xl p-6 text-white">
          ...
          <p className="text-2xl font-bold mt-2">₹{data.totalExpense.toFixed(2)}</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl p-6 text-white">
          ...
          <p className="text-2xl font-bold mt-2">₹{data.savings.toFixed(2)}</p>
        </div>
      </div>
      ...
      <div className="bg-surface border border-border rounded-2xl p-6 mb-8">
        <div className="flex items-center justify-between mb-2">
          <div>
            ...
            <p className="text-3xl font-bold text-text mt-1">₹{data.totalExpense.toFixed(2)}</p>
          </div>
...
/>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div className="bg-surface border border-border rounded-2xl p-6">
          <h2 className="text-text font-semibold mb-4">Expenses by Category</h2>
          {chartData.length > 0 ? (
